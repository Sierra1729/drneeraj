# Dr. Neeraj K Gupta's Practice

Design a premium, modern, trustworthy personal-brand website for a doctor named Dr. Neeraj K Gupta. It should feel calm, premium, and human — like a boutique private practice, not a hospital template or a generic SaaS landing page. The main goal is to get visitors to click "Book Appointment" or "Chat on WhatsApp".
...
Why Choose Dr. Neeraj K Gupta — 4 short reasons with icons (e.g. Personalized Attention, Evidence-Based Care, Clear Communication, Patient-Centered Approach).
...
WhatsApp: Every WhatsApp button (navbar, hero, contact, and a floating bottom-right button on every page) should link to https://wa.me/[WHATSAPP_NUMBER]?text=Hello%20Dr.%20Neeraj%20K%20Gupta%2C%20I%20would%20like%20to%20book%20an%20appointment. On mobile, add a persistent sticky bottom bar with large Call and WhatsApp buttons.

Content rule: Don't invent real facts about Dr. Neeraj K Gupta — no made-up experience numbers, awards, or patient counts. Use clear placeholders: [SPECIALIZATION], [QUALIFICATIONS], [YEARS_OF_EXPERIENCE], [CLINIC_ADDRESS], [PHONE_NUMBER], [WHATSAPP_NUMBER], [EMAIL_ADDRESS].
